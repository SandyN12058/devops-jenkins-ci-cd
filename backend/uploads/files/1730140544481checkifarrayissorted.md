Given an array nums, return true _if the array was originally sorted in non-decreasing order, then rotated_ _**some**_ _number of positions (including zero)_. Otherwise, return false.
